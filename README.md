...
### 7. Analisis de logs ###
Buscar en app.log los logs de la aplicación y tomar dos errores, explicar por qué sucedieron y como solucionarlos.
- Describe qué ocurrió y por qué se produjo el error.
- Explica cómo se podría solucionar o prevenir.
- (Opcional) Muestra, si es necesario, un fragmento de código corregido o un ejemplo de la solución.

### Nota. ###
Para la implementación de las API's utilizar solo las clases necesarias, no exponer métodos públicos que no se necesitan.

### 8. Endpoint UPDATE (Opcional) ###
...
1 - Enviar el codigo al correo de: cecilia.garcia@vaitty.com con copia a: javier@vaitty.com y franco.garcia@vaitty.com
