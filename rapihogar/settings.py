...
LOGGING = {
    'version': 1,
    'disable_existing_loggers': False,  # No desactivar los loggers de Django
    'formatters': {
        'verbose': {
    ...
    'handlers': {
        'file': {
            'level': 'DEBUG',  # capturás todo
            'class': 'logging.FileHandler',
            'filename': os.path.join(BASE_DIR, 'app.log'),  # archivo donde se guardan los logs
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
